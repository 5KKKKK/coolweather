...
import com.example.yanhoor.coolweather.model.County;
import com.example.yanhoor.coolweather.model.Province;
...
//    查询所有省，优先从数据库，没有就从服务器查
    private void queryProvinces(){
        ...
        if (provinceList.size()>0){
            ...
            listView.setSelection(0);//设置当前被选择的项目
    ...
    //捕获back键，根据当前级别来判断此时应该返回市列表、省列表还是退出
    @Override
